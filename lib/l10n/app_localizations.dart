...
abstract class AppLocalizations {
  ...
  /// No description provided for @logoDisplayMode.
  ///
  /// In en, this message translates to:
  /// **'Logo Display Mode'**
  String get logoDisplayMode;

  /// No description provided for @logoModeAuto.
  ///
  /// In en, this message translates to:
  /// **'Auto'**
  String get logoModeAuto;

  /// No description provided for @logoModeCustom.
  ///
  /// In en, this message translates to:
  /// **'Custom'**
  String get logoModeCustom;

  /// No description provided for @logoModeNone.
  ///
  /// In en, this message translates to:
  /// **'Hide'**
  String get logoModeNone;

  /// No description provided for @detectedCompany.
  ///
  /// In en, this message translates to:
  /// **'Detected company'**
  String get detectedCompany;
  ...
  /// No description provided for @companyLogoUrl.
  ///
  /// In en, this message translates to:
  /// **'Logo URL'**
  String get companyLogoUrl;

  /// No description provided for @companyLogoUrlHint.
  ///
  /// In en, this message translates to:
  /// **'https://example.com/logo.png'**
  String get companyLogoUrlHint;
